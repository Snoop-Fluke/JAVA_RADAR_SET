...
public class config_port extends config_para {
	...
	public String decode_hex(String hex, char pro1, char pro2)// getlonghex
																// decodetosubhextoString
	{
		String str1 = "";
		String de_hex = "";
		char[] convert = hex.toCharArray();
		for (int i = 0; i < convert.length; i++) {

			if (convert[i] == pro1 && convert[i + 1] == pro2) {
				i += 2;
				str1 = String.valueOf(convert[i]);
				de_hex = str1.concat(String.valueOf(convert[i + 1]));
