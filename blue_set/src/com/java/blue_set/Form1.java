...
//
//				pg_bar();
//				Class_func.put_json("Set_mode", 0);
//				Class_func.send_json();
//				Class_func.pop_json();
//
...
//		btnRead.setBounds(345, 378, 97, 25);
//		getContentPane().add(btnRead);
//
//		progressBar = new JProgressBar(0, 1000);
//		progressBar.setBounds(184, 483, 283, 39);
